...
public:
    ...
    void rk4_step(double dt, double time);
    void rhs_dt(std::vector<double> &state, std::vector<double> & out, double time, double dt);
    void rhs_linearized(std::vector<double> &state, std::vector<double> & out, double time);
